...
class BranchRequests extends StatefulWidget {
  @override
  _BranchRequestsState createState() => _BranchRequestsState();
}

class _BranchRequestsState extends State<BranchRequests> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: Text('Branch Request'),centerTitle: true,),
      body: _putInBody(),
    );
  }
